...
#ifndef TUNNELOUR_DIRECT3D11_VIEW_TEXTURESHADER_H_
#define TUNNELOUR_DIRECT3D11_VIEW_TEXTURESHADER_H_
...
//  Description : Direct3D11_View_TextureShader contains all the information
//                for using rendering textures from files.
