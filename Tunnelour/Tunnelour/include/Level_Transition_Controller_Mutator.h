...
#ifndef LEVEL_TRANSITION_CONTROLLER_MUTATOR_H_
#define LEVEL_TRANSITION_CONTROLLER_MUTATOR_H_
...
namespace Tunnelour {
class Level_Transition_Controller_Mutator: public Component::Component_Mutator  {
//-----------------------------------------------------------------------------
//  Author(s)   : Sean MacDonnell
//  Description : Level_Transition_Controller_Mutator is a mutator run on the model
...
//-----------------------------------------------------------------------------
 public:
  ...
  //-------------------------------------------------------------------------
  Level_Transition_Controller_Mutator();

  //-------------------------------------------------------------------------
  // Description : Deconstructor
  //-------------------------------------------------------------------------
  virtual ~Level_Transition_Controller_Mutator();
...
#endif  // LEVEL_TRANSITION_CONTROLLER_MUTATOR_H_
