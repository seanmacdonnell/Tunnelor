...
#ifndef TUNNELOUR_DEBUG_BITMAP_H_
#define TUNNELOUR_DEBUG_BITMAP_H_
...
//  Description : Debug_Bitmap is a component for a renderable 2D Sprite
//-----------------------------------------------------------------------------
class Debug_Bitmap: public Tunnelour::Bitmap_Component {
 public:
  //---------------------------------------------------------------------------
