...
#ifndef TUNNELOUR_BACKGROUND_COLOR_COMPONENT_H_
#define TUNNELOUR_BACKGROUND_COLOR_COMPONENT_H_
...
//  Description : Background_Color_Component contains all the information
//                for setting the backbuffer of the window.
//-----------------------------------------------------------------------------
class Background_Color_Component: public Tunnelour::Component {
 public:
  //---------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------
  virtual ~Background_Color_Component();
