...
#ifndef TUNNELOUR_LEVEL_TILE_CONTROLLER_MUTATOR_H_
#define TUNNELOUR_LEVEL_TILE_CONTROLLER_MUTATOR_H_
...
namespace Tunnelour {
class Level_Tile_Controller_Mutator: public Component::Component_Mutator  {
//-----------------------------------------------------------------------------
//  Author(s)   : Sean MacDonnell
//  Description : Level_Tile_Controller_Mutator is a mutator run on the model
...
//-----------------------------------------------------------------------------
 public:
  ...
  //-------------------------------------------------------------------------
  Level_Tile_Controller_Mutator();

  //-------------------------------------------------------------------------
  // Description : Deconstructor
  //-------------------------------------------------------------------------
  virtual ~Level_Tile_Controller_Mutator();
...
#endif  // TUNNELOUR_LEVEL_TILE_CONTROLLER_MUTATOR_H_
