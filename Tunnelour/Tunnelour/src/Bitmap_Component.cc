...
// public:
//------------------------------------------------------------------------------
Bitmap_Component::Bitmap_Component(): Component() {
  m_d3d11device = 0;

  m_frame = new Tunnelour::Bitmap_Component::Frame();
...
//---------------------------------------------------------------------------
Tunnelour::Bitmap_Component::Frame * const Bitmap_Component::GetFrame() {
  return m_frame;
}

//---------------------------------------------------------------------------
void Bitmap_Component::SetFrame(Tunnelour::Bitmap_Component::Frame * frame) {
  m_frame = frame;
}
...
//---------------------------------------------------------------------------
D3DXVECTOR2 * const Bitmap_Component::GetPosition() {
  return &m_position;
}

//---------------------------------------------------------------------------
void Bitmap_Component::SetPosition(D3DXVECTOR2 * const position) {
  m_position = *position;
}

//---------------------------------------------------------------------------
D3DXVECTOR2 * const Bitmap_Component::GetSize() {
  return &m_size;
}

//---------------------------------------------------------------------------
void Bitmap_Component::SetSize(D3DXVECTOR2 * const size) {
  m_size = *size;
}
