...
void Level_Controller::LoadLevelMetadata() {
  ...
  level_metadata = LoadLevelMetadataIntoStruct(level_metadata_file_path);
  level_csv_file_path = String_Helper::WStringToString(m_game_settings->GetLevelPath() + L"Testing_Wall_Collision.csv");
  LoadLevelCSVIntoStruct(level_csv_file_path, &level_metadata);
  m_levels.push_back(level_metadata);
  level_metadata_file_path = String_Helper::WStringToString(m_game_settings->GetLevelPath() + L"Testing_Falling_To_The_Right.txt");
  level_metadata = LoadLevelMetadataIntoStruct(level_metadata_file_path);
  level_csv_file_path = String_Helper::WStringToString(m_game_settings->GetLevelPath() + L"Testing_Falling_To_The_Right.csv");
  LoadLevelCSVIntoStruct(level_csv_file_path, &level_metadata);
  m_levels.push_back(level_metadata);
  level_metadata_file_path = String_Helper::WStringToString(m_game_settings->GetLevelPath() + L"Testing_Falling_To_The_Left.txt");
  level_metadata = LoadLevelMetadataIntoStruct(level_metadata_file_path);
  level_csv_file_path = String_Helper::WStringToString(m_game_settings->GetLevelPath() + L"Testing_Falling_To_The_Left.csv");
  LoadLevelCSVIntoStruct(level_csv_file_path, &level_metadata);
  m_levels.push_back(level_metadata);
  level_metadata_file_path = String_Helper::WStringToString(m_game_settings->GetLevelPath() + L"Testing_Falling_Further.txt");
  level_metadata = LoadLevelMetadataIntoStruct(level_metadata_file_path);
