...
void Procedural_Level_Tile_Controller::CreateLevel() {
  ...
  m_created_tiles = GenerateStartingTunnel(m_level->GetCurrentLevel());
  SwitchTileset();
}
...
//------------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::ShowLevel() {
  for (std::vector<Tile_Bitmap*>::iterator tile = m_created_tiles.begin(); tile != m_created_tiles.end(); ++tile) {
...
//------------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::HideLevel() {
  for (std::vector<Tile_Bitmap*>::iterator tile = m_created_tiles.begin(); tile != m_created_tiles.end(); ++tile) {
...
//------------------------------------------------------------------------------
std::vector<Tile_Bitmap*> Procedural_Level_Tile_Controller::GetExitTiles() {
  return m_exit_tiles;
}
...
// private:
//------------------------------------------------------------------------------
std::vector<Tile_Bitmap*> Procedural_Level_Tile_Controller::GenerateStartingTunnel(Level_Component::Level_Metadata level_metadata) {
  ...
  for (number_of_rows = 1; number_of_rows < 40; number_of_rows++) {
    ...
    for (number_of_columns = 1; number_of_columns < 40; number_of_columns++) {
      Tile_Bitmap* new_tile = 0;
      float position_x = level_metadata.start_avatar_top_left_x;
      float position_y = level_metadata.start_avatar_top_left_y;
      float position_z = 0;
      new_tile = CreateBackgroundTile(128);
      position_z = 0;

      position_x += (128 / 2) + offset_x + current_block_x;
      position_y -= (128 / 2) + offset_y + current_block_y;
...
//------------------------------------------------------------------------------
/*
std::vector<Tile_Bitmap*> Procedural_Level_Tile_Controller::GenerateTunnelFromMetadata(Level_Component::Level_Metadata level_metadata) {
  LoadTilesetMetadata();
...
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::LoadTilesetMetadata() {
...
//---------------------------------------------------------------------------
Tileset_Helper::Tileset_Metadata Procedural_Level_Tile_Controller::GetNamedTileset(std::string name) {
...
//---------------------------------------------------------------------------
Tileset_Helper::Subset Procedural_Level_Tile_Controller::GetCurrentMiddlegroundSubset() {
...
//---------------------------------------------------------------------------
Tileset_Helper::Subset Procedural_Level_Tile_Controller::GetCurrentMiddlegroundSubsetType(Procedural_Level_Tile_Controller::Middleground_Tile_Type types) {
  Tileset_Helper::Subset found_subset;
...
//---------------------------------------------------------------------------
Tileset_Helper::Subset Procedural_Level_Tile_Controller::GetCurrentBackgroundSubsetType(Procedural_Level_Tile_Controller::Background_Tile_Type types) {
  Tileset_Helper::Subset found_subset;
...
//---------------------------------------------------------------------------
Procedural_Level_Tile_Controller::Middleground_Tile_Type Procedural_Level_Tile_Controller::ParseSubsetTypesFromString(std::string type) {
...
//---------------------------------------------------------------------------
Procedural_Level_Tile_Controller::Background_Tile_Type Procedural_Level_Tile_Controller::ParseSubsetBackgroundTypesFromString(std::string type) {
...
//---------------------------------------------------------------------------
Tileset_Helper::Subset Procedural_Level_Tile_Controller::GetCurrentNamedSubset(std::string name) {
  Tileset_Helper::Subset found_subset;
...
//---------------------------------------------------------------------------
Tileset_Helper::Subset Procedural_Level_Tile_Controller::GetCurrentBackgroundSubset() {
  Tileset_Helper::Subset found_subset;
...
//------------------------------------------------------------------------------
Tile_Bitmap* Procedural_Level_Tile_Controller::CreateMiddlegroundTile(float base_tile_size) {
...
//------------------------------------------------------------------------------
Tile_Bitmap* Procedural_Level_Tile_Controller::CreateBackgroundTile(float base_tile_size) {
...
//---------------------------------------------------------------------------
Tileset_Helper::Line Procedural_Level_Tile_Controller::GetCurrentSizedMiddlegroundLine(float size) {
  Tileset_Helper::Line tile_line;
  std::vector<Tileset_Helper::Line>::iterator line;
  for (line = m_current_middleground_subset.lines.begin(); line != m_current_middleground_subset.lines.end(); line++) {
...
//---------------------------------------------------------------------------
Tileset_Helper::Line Procedural_Level_Tile_Controller::GetSizedNamedLine(Tileset_Helper::Subset subset, float size) {
  Tileset_Helper::Line tile_line;
  std::vector<Tileset_Helper::Line>::iterator line;
...
//---------------------------------------------------------------------------
Tileset_Helper::Line Procedural_Level_Tile_Controller::GetCurrentSizedBackgroundLine(float size) {
  Tileset_Helper::Line tile_line;
  std::vector<Tileset_Helper::Line>::iterator line;
  for (line = m_current_background_subset.lines.begin(); line != m_current_background_subset.lines.end(); line++) {
    if (line->tile_size_x == size) {
...
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::ResetMiddlegroundTileTexture(Tile_Bitmap *out_tile) {
...
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::ResetBackgroundTileTexture(Tile_Bitmap *out_tile) {
...
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::SwitchTileset() {
...
/* DEPRECIATED
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::TileUp(float camera_top, float middleground_top) {
...
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::TileDown(float camera_bottom, float middleground_bottom) {
...
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::TileRight(float camera_right, float middleground_right) {
...
//---------------------------------------------------------------------------
void Procedural_Level_Tile_Controller::TileLeft(float camera_left, float middleground_left) {
