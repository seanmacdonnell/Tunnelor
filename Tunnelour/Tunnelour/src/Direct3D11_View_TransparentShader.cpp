...
// public:
//------------------------------------------------------------------------------
Direct3D11_View_TransparentShader::Direct3D11_View_TransparentShader() {
  m_hwnd = 0;
  m_d3d11device = 0;
...
//------------------------------------------------------------------------------
void Direct3D11_View_TransparentShader::Init(ID3D11Device *d3d11device, HWND *hwnd) {
  m_hwnd = hwnd;
...
//------------------------------------------------------------------------------
void Direct3D11_View_TransparentShader::Render(ID3D11DeviceContext* devicecontext,
                                               int index,
                                               D3DXMATRIX world,
                                               D3DXMATRIX view,
...
//------------------------------------------------------------------------------
bool Direct3D11_View_TransparentShader::IsInitialised() {
